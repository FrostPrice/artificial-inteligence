...
public class Personagem extends Agente {
	...
	public void DesenhaSe(Graphics2D dbg, int XMundo, int YMundo) {
		dbg.drawImage(AnimeSet, (int) X - XMundo, (int) Y - YMundo, (int) (X + sizeX) - XMundo,
				(int) (Y + sizeY) - YMundo, sizeX * frame, sizeY * animacao, (sizeX * frame) + sizeX,
				(sizeY * animacao) + sizeY, null);
	}

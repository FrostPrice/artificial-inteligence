  ...
  public static void main(String[] args) {
    ...
    try (BufferedReader reader = new BufferedReader(new FileReader("movie_dataset.csv"))) {
      ...
      while ((line = reader.readLine()) != null) {
        ...
        // * AND Rules
        // Vote Average and Vote Count = Interesting
        applyAndRule(fuzzyVariables, "High Vote Average", "High Vote Count", "Very Interesting");
        applyAndRule(fuzzyVariables, "Medium Vote Average", "High Vote Count", "Average Interesting");
        applyAndRule(fuzzyVariables, "Low Vote Average", "High Vote Count", "Average Interesting");

        applyAndRule(fuzzyVariables, "High Vote Average", "Medium Vote Count", "Very Interesting");
        applyAndRule(fuzzyVariables, "Medium Vote Average", "Medium Vote Count", "Average Interesting");
        applyAndRule(fuzzyVariables, "Low Vote Average", "Medium Vote Count", "Average Interesting");

        applyAndRule(fuzzyVariables, "High Vote Average", "Low Vote Count", "Average Interesting");
        applyAndRule(fuzzyVariables, "Medium Vote Average", "Low Vote Count", "Low Interesting");
        applyAndRule(fuzzyVariables, "Low Vote Average", "Low Vote Count", "Low Interesting");

        // Revenue and Popularity = Interesting
        applyAndRule(fuzzyVariables, "High Revenue", "High Popularity", "Very Interesting");
        applyAndRule(fuzzyVariables, "Medium Revenue", "High Popularity", "Very Interesting");
        applyAndRule(fuzzyVariables, "Low Revenue", "High Popularity", "Average Interesting");

        applyAndRule(fuzzyVariables, "High Revenue", "Medium Popularity", "Very Interesting");
        applyAndRule(fuzzyVariables, "Medium Revenue", "Medium Popularity", "Average Interesting");
        applyAndRule(fuzzyVariables, "Low Revenue", "Medium Popularity", "Average Interesting");

        applyAndRule(fuzzyVariables, "High Revenue", "Low Popularity", "Average Interesting");
        applyAndRule(fuzzyVariables, "Medium Revenue", "Low Popularity", "Average Interesting");
        applyAndRule(fuzzyVariables, "Low Revenue", "Low Popularity", "Low Interesting");
